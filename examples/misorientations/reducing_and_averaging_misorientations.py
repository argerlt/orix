...
fig_1.suptitle("Reduced (red) and equivalent (black) \nrepresentations in point group Oh (m-3m)")
...
fig2.suptitle("Reduced (red), Original (black), and symmetry-aware \nMean (blue) for {C3(3)-> D2(222)} system")
...
ax_ave.set_ylim([-1,1])
ax_ave.set_zlim([-1,1])
fig_ave.suptitle("Original (black), Reduced (red), and flipped(green) \nrepresentations for point group D2 (222)")
